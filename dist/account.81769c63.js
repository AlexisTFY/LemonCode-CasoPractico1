...
exports.updateAccount = exports.insertAccount = exports.gettAccount = void 0;
...
var gettAccount = function gettAccount(id) {
  return _axios.default.get("".concat(url, "/").concat(id)).then(function (response) {
    return response.data;
  });
};

exports.gettAccount = gettAccount;
...
if (isEditMode) {
  (0, _account2.gettAccount)(params.id).then(function (apiAccount) {
...
(0, _helpers.onUpdateField)('type', function (event) {
  ...
  _account.formValidations.validateField('type', account.type).then(function (result) {
...
(0, _helpers.onUpdateField)('alias', function (event) {
  ...
  _account.formValidations.validateField('alias', account.alias).then(function (result) {
...
(0, _helpers.onSubmitForm)('save-button', function () {
  _account.formValidations.validateForm(account).then(function (result) {
