...
exports.getMovements = exports.getMovement = void 0;
...
var getMovement = function getMovement(id) {
...
exports.mapMovementsFromApiToVm = void 0;
...
exports.mapMovementsFromApiToVm = mapMovementsFromApiToVm;
...
var isMovementsAccountMode = Boolean(params.id);

if (isMovementsAccountMode) {
  (0, _movements.getMovement)(params.id).then(function (movements) {
    var viewModelMovements = (0, _movements3.mapMovementsFromApiToVm)(movements);
...
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
