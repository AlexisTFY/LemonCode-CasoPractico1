...
var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post("".concat(urlTransfer, "/").concat(transfer.id), transfer).then(function (response) {
    return response.data;
  });
};
...
},{}],"pages/transfer/day.validations.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setErrorMessage = exports.dayValidator = void 0;

var _fonk = require("@lemoncode/fonk");

var defaultMessage = 'Introduzca un día correcto (1 al 31)';
...
var hasValidDay = function hasValidDay(value) {
  return value <= 31;
};

var dayValidator = function dayValidator(fieldValidatorArgs) {
  var value = fieldValidatorArgs.value,
      _fieldValidatorArgs$m = fieldValidatorArgs.message,
      message = _fieldValidatorArgs$m === void 0 ? defaultMessage : _fieldValidatorArgs$m;
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/month.validations.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setErrorMessage = exports.monthValidator = void 0;

var _fonk = require("@lemoncode/fonk");

var defaultMessage = 'Introduzca un mes correcto (1 al 12)';
...
var hasValidMonth = function hasValidMonth(value) {
  return value <= 12;
};

var monthValidator = function monthValidator(fieldValidatorArgs) {
  var value = fieldValidatorArgs.value,
      _fieldValidatorArgs$m = fieldValidatorArgs.message,
      message = _fieldValidatorArgs$m === void 0 ? defaultMessage : _fieldValidatorArgs$m;
  var validationResult = {
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/year.validations.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.yearValidator = exports.setErrorMessage = void 0;

var _fonk = require("@lemoncode/fonk");

var defaultMessage = 'Introduzca un año correcto (Año superior al  2022)';
...
var hasValidYear = function hasValidYear(value) {
  return value >= 2022;
};

var yearValidator = function yearValidator(fieldValidatorArgs) {
  var value = fieldValidatorArgs.value,
      _fieldValidatorArgs$m = fieldValidatorArgs.message,
      message = _fieldValidatorArgs$m === void 0 ? defaultMessage : _fieldValidatorArgs$m;
  var validationResult = {
...
var _day = require("./day.validations");

var _month = require("./month.validations");

var _year = require("./year.validations");

var validationsShema = {
  field: {
    iban: [{
      ...
      customArgs: {
        pattern: new RegExp(/^([A-Z]{2})(\d{2}\s?)(\d{4}\s?){4}\d{4}$/)
      },
    ...
    day: [{
      ...
      validator: _day.dayValidator
    }],
    month: [{
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
    }, {
      validator: _month.monthValidator
    }],
    year: [{
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
    }, {
      validator: _year.yearValidator
    }],
    email: [{
      validator: _fonk.Validators.required,
      message: 'Campo requerido'
...
var formValidations = (0, _fonk.createFormValidation)(validationsShema);
exports.formValidations = formValidations;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","./day.validations":"pages/transfer/day.validations.js","./month.validations":"pages/transfer/month.validations.js","./year.validations":"pages/transfer/year.validations.js"}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";
...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfer3.formValidations.validateField('iban', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfer3.formValidations.validateField('name', transfer.name).then(function (result) {
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _transfer3.formValidations.validateField('amount', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfer3.formValidations.validateField('concept', transfer.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _transfer3.formValidations.validateField('notes', transfer.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  _transfer3.formValidations.validateField('day', transfer.day).then(function (result) {
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  _transfer3.formValidations.validateField('month', transfer.month).then(function (result) {
...
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  _transfer3.formValidations.validateField('year', transfer.year).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfer3.formValidations.validateField('email', transfer.email).then(function (result) {
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  var date = "".concat(transfer.day, "/").concat(transfer.month, "/").concat(transfer.year);
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    date: date
  });

  _transfer3.formValidations.validateForm(transfer).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);

    if (result.succeeded) {
      console.log(result.succeeded);
      console.log(transfer);
      (0, _transfer.insertTransfer)(transfer);
    }
  });
});
},{"./transfer.api":"pages/transfer/transfer.api.js","../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.validations":"pages/transfer/transfer.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
